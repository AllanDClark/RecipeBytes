...
namespace RecipeBytes.Infrastructure.Migrations
{
    ...
    [Migration("20240412235520_moreseeds")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeBytes.Domain.Entities.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("082e3d35-95b2-409a-9ba9-c8c9b15a877b"),
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Noodles and pork",
                            ImageUrl = "https://res.cloudinary.com/daspbl6sb/image/upload/v1712964559/whk9yu5xsbr7cvszwtte.jpg",
                            IsSoftDeleted = false,
                            Name = "Ramen noodles",
                            UpdatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("96a6f4e5-e108-4b8f-8c47-1a2c98d6019e"),
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "What I said was, 'give me all the bacon and eggs you have.'",
                            ImageUrl = "https://res.cloudinary.com/daspbl6sb/image/upload/v1712964467/james-kern-aLDW0oQ0NtU-unsplash_ypclxp.jpg",
                            IsSoftDeleted = false,
                            Name = "Bacon and Eggs",
                            UpdatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("739defb6-3d8a-432e-a4e7-0171e22a3a0f"),
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Marg-her-ehhh-tay",
                            ImageUrl = "https://res.cloudinary.com/daspbl6sb/image/upload/v1712964879/bwglvzxvy9uzdwwglhzb.jpg",
                            IsSoftDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("b8a3efb4-50bd-41b5-832e-3d59d783b4a9"),
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Why did the taco go to the party? Because it wanted to taco 'bout it later!",
                            ImageUrl = "https://res.cloudinary.com/daspbl6sb/image/upload/v1712965310/o2qgx0yifaty6ikcpmf1.jpg",
                            IsSoftDeleted = false,
                            Name = "Carnitas Tacos",
                            UpdatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = new Guid("a2c3c1e1-f0ed-4d4d-a698-9f7ee2177d8b"),
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "It is not a lie.",
                            ImageUrl = "https://res.cloudinary.com/daspbl6sb/image/upload/v1712965428/hjc02v2ngl00lc0zgxtx.jpg",
                            IsSoftDeleted = false,
                            Name = "Chocolate Cake",
                            UpdatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        });
            ...
            modelBuilder.Entity("IngredientRecipe", b =>
                {
                    b.HasOne("RecipeBytes.Domain.Entities.Ingredient", null)
                        .WithMany()
